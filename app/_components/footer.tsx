...
const Footer = () => {
    return (
        <footer className="py-8 px-4 md:px-14 lg:px-[4.875rem] bg-black selection:bg-brand-green selection:text-black flex flex-wrap items-center justify-between gap-8">
            <Link href="/">
